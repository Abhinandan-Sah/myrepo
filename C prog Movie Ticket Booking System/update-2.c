...
void Movie_review(){
    printf("Best movie ever. recommend 100%\nMust movie");
}

void Show_Movie_Details(){
    // printf("I am inside show movie");
    printf("Movies Running in the threaters are: \n\n");

    printf("In Hollywood\n 1. Persuit of Happiness\n");

    printf("In Indian Cinema\n 2. KGF: Chapter 3\n\n");

    printf("For Review of Movie no.1 : Press 1/n");
    printf("For Review of Movie no.2 : Press 1/n");
    int choose;
    scanf("%d", &choose);
    switch(choose){
        case 1: Movie_review();
